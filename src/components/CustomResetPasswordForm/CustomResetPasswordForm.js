...
const CustomResetPasswordForm = ({ login, slug }) => {
      ...
      <div className="sign-container">
        ...
        <div className="sign-content">
          <form onSubmit={handleSubmit}>
            ...
            {!loading ? <button className="btn btn-send" style={{ backgroundColor: login.login_page_colour }} type="submit">Submit</button>
...
export default CustomResetPasswordForm;
