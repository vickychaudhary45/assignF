              ...
              <div className="input-group">
                <div className="input-box" key={1}>
                  ...
                  <div className='input-div'>
                    <input type="text" className='input-field' value={data.rdp_user_name} disabled />
                    {copied[data.rdp_user_name] ? (<span> Copied! </span>)
                      : (
                        <ContentCopy className='copy-btn' onClick={() => handleCopy(data.rdp_user_name)} />
                      )}
                  </div>
                  <label>User Password</label>
                  <div className='input-div'>
                    <input type="text" className='input-field' value={data.rdp_user_password} disabled />
                    {copied[data.rdp_user_password] ? (<span> Copied! </span>)
                      : (
                        <ContentCopy className='copy-btn' onClick={() => handleCopy(data.rdp_user_password)} />
                      )}
                  </div>
