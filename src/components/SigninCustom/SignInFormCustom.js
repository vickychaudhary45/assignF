...
const SignInCustomForm = ({ login, userInfo, slug }) => {
      ...
      <div className="sign-container">
        ...
        <div className="sign-content">
          <form action="#" onSubmit={handleSubmit(onSubmit)}>
            ...
            {!loading ? (<button style={{ backgroundColor: login.login_page_colour }} className="btn">Login </button>)
              : (<CircularProgress size={15} />)}
          </form>
          <Link to={`/forgot-password/${slug}`} className="forgot-password">
            Forgot Password
          </Link>
        </div>
      </div>
...
export default SignInCustomForm;
